...
class speedTyping {
    ...
    start() {
        ...
        max=allQuotes.length;
        function getRandomNumber(min, max) {
           var ran = Math.floor(Math.random() * (max - min) + min);
            return ran;
           };
           i=getRandomNumber(0, max);
        this.quote  = allQuotes[i].quote;
        this.author = allQuotes[i].author;
  ...
  ontinfo.innerHTML=" ";
    ...
    stop() {
        ...
        inputFull.innerHTML = `&#8220;${this.quote}&#8221; <span class="d-block small text-muted text-right pr-3"> <p id="author-name">${this.author}</p></span></div> `;
        // Completely stop
        document.getElementById("textOutput").style.opacity = "0";
        document.getElementById("textOutput").style.zIndex = "-1";
    ...
    finish() {
        ...
        if (wpm > 5 && wpm < 20) {
            result = `
                <div class="modal-icon my-3"><img src="img/sleeping.jfif" class="media-object"></div>
            ...
            result = `
                <div class="modal-icon my-3"><img src="img/thinking.jfif" class="media-object"></div>
                <div class="media-body p-2">
            ...
            result = `
                <div class="modal-icon my-3"><img src="img/love.jfif" class="media-object"></div>
                <div class="media-body p-2">
            ...
            result = `
                <div class="modal-icon my-3"><img src="img/shocked.jpg" class="media-object"></div>
                <div class="media-body p-2">
            ...
            result = `
                <div class="modal-icon my-3"><img src="img/smart.jfif" class="media-object"></div>
                <div class="media-body p-2">
